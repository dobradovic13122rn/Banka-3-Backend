...
const (
	...
	ExchangeService_ConvertMoney_FullMethodName     = "/exchange.ExchangeService/ConvertMoney"
)
...
type ExchangeServiceClient interface {
	GetExchangeRates(ctx context.Context, in *ExchangeRateListRequest, opts ...grpc.CallOption) (*ExchangeRateListResponse, error)
	ConvertMoney(ctx context.Context, in *ConversionRequest, opts ...grpc.CallOption) (*ConversionResponse, error)
}
...
func (c *exchangeServiceClient) GetExchangeRates(ctx context.Context, in *ExchangeRateListRequest, opts ...grpc.CallOption) (*ExchangeRateListResponse, error) {
...
func (c *exchangeServiceClient) ConvertMoney(ctx context.Context, in *ConversionRequest, opts ...grpc.CallOption) (*ConversionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ConversionResponse)
	err := c.cc.Invoke(ctx, ExchangeService_ConvertMoney_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExchangeServiceServer interface {
	GetExchangeRates(context.Context, *ExchangeRateListRequest) (*ExchangeRateListResponse, error)
	ConvertMoney(context.Context, *ConversionRequest) (*ConversionResponse, error)
...
func (UnimplementedExchangeServiceServer) GetExchangeRates(context.Context, *ExchangeRateListRequest) (*ExchangeRateListResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetExchangeRates not implemented")
}
func (UnimplementedExchangeServiceServer) ConvertMoney(context.Context, *ConversionRequest) (*ConversionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ConvertMoney not implemented")
}
...
func _ExchangeService_GetExchangeRates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExchangeRateListRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExchangeServiceServer).GetExchangeRates(ctx, req.(*ExchangeRateListRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ExchangeService_ConvertMoney_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConversionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExchangeServiceServer).ConvertMoney(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExchangeService_ConvertMoney_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExchangeServiceServer).ConvertMoney(ctx, req.(*ConversionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ExchangeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ExchangeService_ConvertMoney_Handler,
		},
	},
