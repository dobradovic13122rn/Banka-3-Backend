...
func (*GetEmployeesResponse_Employee) Descriptor() ([]byte, []int) {
	return file_user_user_proto_rawDescGZIP(), []int{35, 0}
}
...
var file_user_user_proto_goTypes = []any{
	...
	(*CreateAccountRequest)(nil),          // 13: user.CreateAccountRequest
	(*CreateAccountResponse)(nil),         // 14: user.CreateAccountResponse
	(*RefreshRequest)(nil),                // 15: user.RefreshRequest
	(*RefreshResponse)(nil),               // 16: user.RefreshResponse
	(*EmployeeResponse)(nil),              // 17: user.EmployeeResponse
	...
	(*PasswordActionRequest)(nil),         // 22: user.PasswordActionRequest
	(*PasswordActionResponse)(nil),        // 23: user.PasswordActionResponse
	(*SetPasswordWithTokenRequest)(nil),   // 24: user.SetPasswordWithTokenRequest
	(*SetPasswordWithTokenResponse)(nil),  // 25: user.SetPasswordWithTokenResponse
	(*CreateEmployeeRequest)(nil),         // 26: user.CreateEmployeeRequest
	(*CreateClientRequest)(nil),           // 27: user.CreateClientRequest
	(*CreateClientResponse)(nil),          // 28: user.CreateClientResponse
	(*Client)(nil),                        // 29: user.Client
	(*GetClientsRequest)(nil),             // 30: user.GetClientsRequest
	(*GetClientsResponse)(nil),            // 31: user.GetClientsResponse
	(*UpdateClientRequest)(nil),           // 32: user.UpdateClientRequest
	(*UpdateClientResponse)(nil),          // 33: user.UpdateClientResponse
	(*GetEmployeesRequest)(nil),           // 34: user.GetEmployeesRequest
	(*GetEmployeesResponse)(nil),          // 35: user.GetEmployeesResponse
	(*GetEmployeeByIdRequest)(nil),        // 36: user.GetEmployeeByIdRequest
	(*GetEmployeeByEmailRequest)(nil),     // 37: user.GetEmployeeByEmailRequest
	(*GetEmployeeResponse)(nil),           // 38: user.GetEmployeeResponse
	(*UpdateEmployeeRequest)(nil),         // 39: user.UpdateEmployeeRequest
	(*GetEmployeesResponse_Employee)(nil), // 40: user.GetEmployeesResponse.Employee
}
var file_user_user_proto_depIdxs = []int32{
	...
	29, // 4: user.GetClientsResponse.Clients:type_name -> user.Client
	40, // 5: user.GetEmployeesResponse.employees:type_name -> user.GetEmployeesResponse.Employee
	36, // 6: user.UserService.GetEmployeeById:input_type -> user.GetEmployeeByIdRequest
	37, // 7: user.UserService.GetEmployeeByEmail:input_type -> user.GetEmployeeByEmailRequest
	34, // 8: user.UserService.GetEmployees:input_type -> user.GetEmployeesRequest
	39, // 9: user.UserService.UpdateEmployee:input_type -> user.UpdateEmployeeRequest
	...
	13, // 15: user.UserService.CreateAccount:input_type -> user.CreateAccountRequest
	20, // 16: user.UserService.Login:input_type -> user.LoginRequest
	18, // 17: user.UserService.Logout:input_type -> user.LogoutRequest
	15, // 18: user.UserService.Refresh:input_type -> user.RefreshRequest
	2,  // 19: user.UserService.ValidateAccessToken:input_type -> user.ValidateTokenRequest
	2,  // 20: user.UserService.ValidateRefreshToken:input_type -> user.ValidateTokenRequest
	22, // 21: user.UserService.RequestPasswordReset:input_type -> user.PasswordActionRequest
	22, // 22: user.UserService.RequestInitialPasswordSet:input_type -> user.PasswordActionRequest
	24, // 23: user.UserService.SetPasswordWithToken:input_type -> user.SetPasswordWithTokenRequest
	27, // 24: user.UserService.CreateClientAccount:input_type -> user.CreateClientRequest
	30, // 25: user.UserService.GetClients:input_type -> user.GetClientsRequest
	32, // 26: user.UserService.UpdateClient:input_type -> user.UpdateClientRequest
	26, // 27: user.UserService.CreateEmployeeAccount:input_type -> user.CreateEmployeeRequest
	38, // 28: user.UserService.GetEmployeeById:output_type -> user.GetEmployeeResponse
	38, // 29: user.UserService.GetEmployeeByEmail:output_type -> user.GetEmployeeResponse
	35, // 30: user.UserService.GetEmployees:output_type -> user.GetEmployeesResponse
	38, // 31: user.UserService.UpdateEmployee:output_type -> user.GetEmployeeResponse
	1,  // 32: user.UserService.DeleteEmployee:output_type -> user.DeleteEmployeeResponse
	6,  // 33: user.UserService.CreateCompany:output_type -> user.CreateCompanyResponse
	8,  // 34: user.UserService.GetCompanyById:output_type -> user.GetCompanyByIdResponse
	10, // 35: user.UserService.GetCompanies:output_type -> user.GetCompaniesResponse
	12, // 36: user.UserService.UpdateCompany:output_type -> user.UpdateCompanyResponse
	14, // 37: user.UserService.CreateAccount:output_type -> user.CreateAccountResponse
	21, // 38: user.UserService.Login:output_type -> user.LoginResponse
	19, // 39: user.UserService.Logout:output_type -> user.LogoutResponse
	16, // 40: user.UserService.Refresh:output_type -> user.RefreshResponse
	3,  // 41: user.UserService.ValidateAccessToken:output_type -> user.ValidateTokenResponse
	3,  // 42: user.UserService.ValidateRefreshToken:output_type -> user.ValidateTokenResponse
	23, // 43: user.UserService.RequestPasswordReset:output_type -> user.PasswordActionResponse
	23, // 44: user.UserService.RequestInitialPasswordSet:output_type -> user.PasswordActionResponse
	25, // 45: user.UserService.SetPasswordWithToken:output_type -> user.SetPasswordWithTokenResponse
	28, // 46: user.UserService.CreateClientAccount:output_type -> user.CreateClientResponse
	31, // 47: user.UserService.GetClients:output_type -> user.GetClientsResponse
	33, // 48: user.UserService.UpdateClient:output_type -> user.UpdateClientResponse
	38, // 49: user.UserService.CreateEmployeeAccount:output_type -> user.GetEmployeeResponse
