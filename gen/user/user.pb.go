...
func (*GetEmployeesResponse_Employee) Descriptor() ([]byte, []int) {
	return file_user_user_proto_rawDescGZIP(), []int{31, 0}
}
...
const file_user_user_proto_rawDesc = "" +
	...
	"\x19CreateLoanRequestResponse2\xa3\r\n" +
	"\vUserService\x12J\n" +
	...
	"\x15CreateEmployeeAccount\x12\x1b.user.CreateEmployeeRequest\x1a\x19.user.GetEmployeeResponse\x129\n" +
...
var file_user_user_proto_goTypes = []any{
	...
	(*CreateClientRequest)(nil),           // 23: user.CreateClientRequest
	(*CreateClientResponse)(nil),          // 24: user.CreateClientResponse
	(*Client)(nil),                        // 25: user.Client
	(*GetClientsRequest)(nil),             // 26: user.GetClientsRequest
	(*GetClientsResponse)(nil),            // 27: user.GetClientsResponse
	(*UpdateClientRequest)(nil),           // 28: user.UpdateClientRequest
	(*UpdateClientResponse)(nil),          // 29: user.UpdateClientResponse
	(*GetEmployeesRequest)(nil),           // 30: user.GetEmployeesRequest
	(*GetEmployeesResponse)(nil),          // 31: user.GetEmployeesResponse
	(*GetEmployeeByIdRequest)(nil),        // 32: user.GetEmployeeByIdRequest
	(*GetEmployeeByEmailRequest)(nil),     // 33: user.GetEmployeeByEmailRequest
	(*GetEmployeeResponse)(nil),           // 34: user.GetEmployeeResponse
	(*UpdateEmployeeRequest)(nil),         // 35: user.UpdateEmployeeRequest
	(*Loan)(nil),                          // 36: user.Loan
	(*GetLoansRequest)(nil),               // 37: user.GetLoansRequest
	(*GetLoansResponse)(nil),              // 38: user.GetLoansResponse
	(*GetLoanByNumberRequest)(nil),        // 39: user.GetLoanByNumberRequest
	(*CreateLoanRequestRequest)(nil),      // 40: user.CreateLoanRequestRequest
	(*CreateLoanRequestResponse)(nil),     // 41: user.CreateLoanRequestResponse
	(*GetEmployeesResponse_Employee)(nil), // 42: user.GetEmployeesResponse.Employee
}
var file_user_user_proto_depIdxs = []int32{
	...
	25, // 4: user.GetClientsResponse.Clients:type_name -> user.Client
	42, // 5: user.GetEmployeesResponse.employees:type_name -> user.GetEmployeesResponse.Employee
	36, // 6: user.GetLoansResponse.loans:type_name -> user.Loan
	32, // 7: user.UserService.GetEmployeeById:input_type -> user.GetEmployeeByIdRequest
	33, // 8: user.UserService.GetEmployeeByEmail:input_type -> user.GetEmployeeByEmailRequest
	30, // 9: user.UserService.GetEmployees:input_type -> user.GetEmployeesRequest
	35, // 10: user.UserService.UpdateEmployee:input_type -> user.UpdateEmployeeRequest
	...
	23, // 23: user.UserService.CreateClientAccount:input_type -> user.CreateClientRequest
	26, // 24: user.UserService.GetClients:input_type -> user.GetClientsRequest
	28, // 25: user.UserService.UpdateClient:input_type -> user.UpdateClientRequest
	22, // 26: user.UserService.CreateEmployeeAccount:input_type -> user.CreateEmployeeRequest
	37, // 27: user.UserService.GetLoans:input_type -> user.GetLoansRequest
	39, // 28: user.UserService.GetLoanByNumber:input_type -> user.GetLoanByNumberRequest
	40, // 29: user.UserService.CreateLoanRequest:input_type -> user.CreateLoanRequestRequest
	34, // 30: user.UserService.GetEmployeeById:output_type -> user.GetEmployeeResponse
	34, // 31: user.UserService.GetEmployeeByEmail:output_type -> user.GetEmployeeResponse
	31, // 32: user.UserService.GetEmployees:output_type -> user.GetEmployeesResponse
	34, // 33: user.UserService.UpdateEmployee:output_type -> user.GetEmployeeResponse
	...
	24, // 46: user.UserService.CreateClientAccount:output_type -> user.CreateClientResponse
	27, // 47: user.UserService.GetClients:output_type -> user.GetClientsResponse
	29, // 48: user.UserService.UpdateClient:output_type -> user.UpdateClientResponse
	34, // 49: user.UserService.CreateEmployeeAccount:output_type -> user.GetEmployeeResponse
	38, // 50: user.UserService.GetLoans:output_type -> user.GetLoansResponse
	36, // 51: user.UserService.GetLoanByNumber:output_type -> user.Loan
	41, // 52: user.UserService.CreateLoanRequest:output_type -> user.CreateLoanRequestResponse
